...
import { User, Lock, Save, Edit, BookOpen } from "lucide-react"
        ...
        <div className="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-xl p-8 text-white">
          <div className="flex items-center">
            <div className="w-24 h-24 bg-white/20 rounded-full flex items-center justify-center mr-6">
              <span className="text-3xl font-bold">{userData?.name?.charAt(0) || "S"}</span>
            </div>
            <div>
              <h1 className="text-3xl font-bold mb-2 animate-fade-in-up">Student Profile</h1>
              <p className="text-indigo-100 animate-fade-in-up animation-delay-200">
                Manage your learning profile and account settings
              </p>
              <div className="flex items-center mt-2 space-x-4">
                <span
                  className={`px-3 py-1 rounded-full text-sm ${
                    userData?.approved ? "bg-green-500/20 text-green-100" : "bg-yellow-500/20 text-yellow-100"
                  }`}
                >
                  {userData?.approved ? "Approved" : "Pending Approval"}
                </span>
                <span className="bg-white/20 px-3 py-1 rounded-full text-sm">
                  Student since {userData?.createdAt?.toDate?.()?.getFullYear() || "2024"}
                </span>
              </div>
            </div>
          </div>
            ...
            <form onSubmit={handleUpdateProfile} className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="role" value="Student" disabled className="bg-gray-50 text-gray-500" />
                </div>
              </div>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="text-center p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg">
                ...
                <div className="text-sm text-gray-600">Teachers Connected</div>
              </div>
