...
export default function StudentAppointmentsPage() {
  ...
  const fetchAppointments = async (userId: string) => {
    try {
      const appointmentsQuery = query(collection(db, "appointments"), where("studentId", "==", userId))
    ...
    <StudentLayout>
      <div className="space-y-6 animate-fade-in-up">
        ...
        <div className="bg-gradient-to-r from-indigo-600 to-blue-600 rounded-xl p-8 text-white">
          <h1 className="text-3xl font-bold mb-2 animate-fade-in-up">My Appointments</h1>
          <p className="text-indigo-100 animate-fade-in-up animation-delay-200">
            Track your learning sessions and manage your schedule
          </p>
        </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                      <div className="w-12 h-12 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-full flex items-center justify-center">
                        <span className="text-white font-semibold">{appointment.teacherName.charAt(0)}</span>
                      </div>
                      <div>
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      {appointment.status === "pending" && isUpcoming(appointment.date, appointment.time) && (
                        <Button
                          size="sm"
                          variant="outline"
