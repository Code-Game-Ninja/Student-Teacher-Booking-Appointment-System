...
import { BookOpen, Calendar, Users, Menu, X, LogOut, Home, Settings, GraduationCap } from "lucide-react"
        ...
        <div className="border-t border-gray-200 p-4">
          <div className="flex items-center mb-3">
            <div className="w-10 h-10 bg-purple-600 rounded-full flex items-center justify-center">
              <span className="text-white font-semibold text-sm">{userData?.name?.charAt(0) || "A"}</span>
            </div>
