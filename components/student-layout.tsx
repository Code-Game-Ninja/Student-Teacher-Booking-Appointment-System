...
import { BookOpen, Calendar, MessageCircle, User, Users, Menu, X, LogOut, Home } from "lucide-react"
...
export default function StudentLayout({ children }: StudentLayoutProps) {
  ...
  const navigation = [
    ...
    { name: "Find Teachers", href: "/student/teachers", icon: Users },
        ...
        <div className="border-t border-gray-200 p-4">
          <div className="flex items-center mb-3">
            <div className="w-10 h-10 bg-indigo-600 rounded-full flex items-center justify-center">
              <span className="text-white font-semibold text-sm">{userData?.name?.charAt(0) || "S"}</span>
            </div>
            <div className="ml-3 flex-1">
              <p className="text-sm font-medium text-gray-900 truncate">{userData?.name || "Student"}</p>
